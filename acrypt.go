...
// provides a slightly simpler interface, convenient for implementations that
// do not need to use the Bcrypt one.
package acrypt
...
// https://github.com/P-H-C/phc-winner-argon2#usage
